<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-16 01:59:06
         compiled from "/usr/local/lighthouse/softwares/btpanel/server/wepay/959/admin/view/Sys/safety.html" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5fb16c6a2fa900_92858807',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb16c6a2fa900_92858807')) {function content_5fb16c6a2fa900_92858807($_smarty_tpl) {?><style>
.googleBox{
...
echo $_smarty_tpl->tpl_vars['user']->value['phone'];
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" id="phone" data-phone="<?php echo $_smarty_tpl->tpl_vars['user']->value['phone'];?>
" autocomplete="off"  class="layui-input layui-input-inline"> <span style="line-height:38px;">&nbsp;不做绑定可忽略</span>
			</div>
		</div>
		<div class="layui-form-item">
...
" <?php if ($_smarty_tpl->tpl_vars['skey']->value==$_smarty_tpl->tpl_vars['user']->value['is_google']) {?>checked="checked"<?php }?> />
				<?php } ?>
				<div>
...
2、iOS移动设备：进入AppStore，搜索“Google Authenticator”，下载安装。<br>
	...
	<?php if (!$_smarty_tpl->tpl_vars['user']->value['google_hide']) {?>
	<div class="googleBox">
		<div style="text-align:center;padding-bottom:5px;">Google验证添加</div>
		<div style="width:240px;height:208px;background:url(<?php echo $_smarty_tpl->tpl_vars['google_qrcode']->value;?>
) no-repeat center top;">
			
		</div>
		<div style="text-align:left;padding:0 10px;">
		账号：<?php echo $_smarty_tpl->tpl_vars['user']->value['account'];?>
<br>
		密钥：<?php echo $_smarty_tpl->tpl_vars['user']->value['google_secret'];?>
