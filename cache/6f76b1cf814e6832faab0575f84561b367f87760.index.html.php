...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5fb59338098259_85857886',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb59338098259_85857886')) {function content_5fb59338098259_85857886($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  ajax({
    ...
    success:function(json){
      ...
      _alert(json.msg,{icon:1},function(){
		...
		location.href='http://www.wepay.fun/ht.php';
      });
