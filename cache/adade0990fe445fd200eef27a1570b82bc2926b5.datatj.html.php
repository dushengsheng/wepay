...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5fb4c024db9bf1_38815083',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb4c024db9bf1_38815083')) {function content_5fb4c024db9bf1_38815083($_smarty_tpl) {?><div class="layui-card">
		...
		<div class="layui-form-item" style="margin-bottom:5px;">
			<div class="layui-inline" style="margin-right:0;">
				...
				<div class="layui-input-inline" style="width:120px;">
					<input name="s_start_time" id="s_start_time" value="2020-11-11" class="layui-input" placeholder="开始日期" />
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="width:30px;">结束</label>
				<div class="layui-input-inline" style="width:120px;">
					<input name="s_end_time" id="s_end_time" value="2020-11-18" class="layui-input" placeholder="结束日期">
				</div>
			</div>
			<div class="layui-inline">
