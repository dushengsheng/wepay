<?php /*%%SmartyHeaderCode:2530889285fb4c133d32f90-39304054%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b52588d7deccc7735a250bcc1645d01e39747cff' => 
    array (
      0 => '/usr/local/lighthouse/softwares/btpanel/server/wepay/959/admin/view/Pay/skma.html',
      1 => 1581840098,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2530889285fb4c133d32f90-39304054',
  'variables' => 
  array (
    'updateall' => 0,
    'mtype_arr' => 0,
  ...
  'unifunc' => 'content_5fb4c133dc3be5_18982013',
  'cache_lifetime' => 300,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb4c133dc3be5_18982013')) {function content_5fb4c133dc3be5_18982013($_smarty_tpl) {?><style>
            ...
            <div class="layui-input-block" style="width:160px;">
                <select id="mtype_id" lay-filter="mtype_id">
					<option value="0">请选择类型</option>
                                        <option value="1" data-type="2">支付宝扫码</option>
                                        <option value="2" data-type="2">微信扫码</option>
                                        <option value="3" data-type="3">银行卡转账</option>
                                        <option value="4" data-type="1">微信转手机</option>
                                        <option value="5" data-type="3">微信银行卡</option>
                                        <option value="6" data-type="2">云闪付</option>
                                        <option value="11" data-type="4">吱口令</option>
                                        <option value="12" data-type="5">支付宝转账码</option>
                                    </select>
            </div>
        </div>
