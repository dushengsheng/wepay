<?php /* Smarty version Smarty-3.1.21-dev, created on 2020-11-18 14:42:46
         compiled from "/usr/local/lighthouse/softwares/btpanel/server/wepay/959/home/view/Skma/index.html" */ ?>
<?php /*%%SmartyHeaderCode:7242275755fb4c26663db59-24195251%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b81a546f03b32912e61778a42c8afbf621f0606d' => 
    array (
      0 => '/usr/local/lighthouse/softwares/btpanel/server/wepay/959/home/view/Skma/index.html',
      1 => 1599911298,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7242275755fb4c26663db59-24195251',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fb4c2666ffed3_83933663',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fb4c2666ffed3_83933663')) {function content_5fb4c2666ffed3_83933663($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value['bank_name'];?>
				...
				<div class="Row">
					<p class="lttxt">收款账号：</p>
					<div class="inputbox"><input type="text" id="ma_account" placeholder="支付宝/微信/手机号/卡号"></div>
				</div>
				<!--
				<div class="Row">
...
"><?php echo $_smarty_tpl->tpl_vars['vo']->value;?>
				...
				<div class="Row state">
					<p class="lttxt">状态：</p>
					<div class="stateNav"><span class="on" data-status="2">在线</span><span data-status="1">下线</span></div>
				</div>
...
$(function(){
	...
	$('.addIdNum').on('click',function(){
		var mtype_id='<?php echo $_smarty_tpl->tpl_vars['s']->value['mtype'];?>
';
		if(!mtype_id){
			mtype_id=1;
		}
	...
	$('.confirmBtn').on('click',function(){
		...
		ajax({
			...
			data:{
				...
				min_money:min_money,max_money:max_money,match_num:match_num,
	...
	function parseSkma(item){
		...
		html+='<li class="skmaItem" data-id="'+item.id+'">';
			...
			html+='<div class="rtbox">';
				...
				html+='<p>省市：'+item.province_name+'/'+item.city_name+'</p>';
				html+='<p>最大收款：'+item.max_money+'</p>';
				html+='<p>提成：'+item.yong_money+'</p>';
